package com.example.omsairam.mapurtravel
    ...
    override fun onResume() {
        ...
        try{
            ...
            while(cursor != null){
                ...
                val latitudeCordinate = latitudeFromDatabase.toDouble()
                val longitudeCordinate =longitudeFromDatabase.toDouble()

                val location =LatLng(latitudeCordinate,longitudeCordinate)
        ...
        listView.setOnItemClickListener { adapterView, view, i, l ->
            ...
            intent.putExtra("names",namesArray[i])
